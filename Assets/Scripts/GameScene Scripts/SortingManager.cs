...
public class SortingManager : MonoBehaviour
{
   ...
   // int currentStep = -1;
    ...
    private void MoveInTree(StepInfo stepInfo)
    {
        System.Collections.Generic.Queue<StepInfo> queue = this.stepQueue;
       ...
       // GameObject lineNodeChild = stepInfo.lineNodeChild;
        ...
        // {
        //     if (stepInfo.stepType == StepTypes.Tausche)
        //     {
        //         throw new System.Exception("this should not happen.");
        //     }
        //     {
    ...
    public void IncreaseStep()
    {
        ...
        else
        {
            ...
            if (sortingStepIndex % 2 == 1) // Tausche.
            {
                ...
                StepInfo stepInfo = new StepInfo(0, tailIndex, StepTypes.Tausche, this);
    ...
    private void AddStep4BuildSubHeap(int targetIndex)
    {
        ...
        if (targetIndex * 2 + 1 < unSortedCount)
        {
            StepInfo stepInfo = new StepInfo(targetIndex, childIndex, StepTypes.Versickere, this);
            this.stepQueue.Enqueue(stepInfo);
        }
    }
